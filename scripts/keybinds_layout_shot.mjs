...
if (wide && wide.width > 0)
  await page.screenshot({ path: 'tmp/keybinds_wide_panel.png', clip: wide });
...
if (mob && mob.width > 0)
  await page.screenshot({ path: 'tmp/keybinds_mobile_panel.png', clip: mob });
console.log('mobile panel width:', mob?.width);

if (errors.length) console.log('PAGE ERRORS:\n' + errors.join('\n'));
console.log(
  'wrote tmp/keybinds_wide_panel.png, tmp/keybinds_wide_full.png, tmp/keybinds_mobile_panel.png, tmp/keybinds_mobile_full.png',
);
await browser.close();
