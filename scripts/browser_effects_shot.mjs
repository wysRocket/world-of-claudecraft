...
if (box && box.width > 0)
  await page.screenshot({ path: 'tmp/browser_effects_graphics_panel.png', clip: box });
...
console.log(
  'wrote tmp/browser_effects_{start_full,start_minimal,graphics_full,graphics_panel}.png',
);
await browser.close();
