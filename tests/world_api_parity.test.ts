...
// it lands the matching edit here in the SAME commit. The count pins (170 / 43 / 127)
...
// Partition: 43 `data` + 127 `method` (read-returning + command-void + async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  ...
  it('the sorted method-kind set is exactly the pinned 127', () => {
