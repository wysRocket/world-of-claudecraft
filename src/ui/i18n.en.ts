...
export const en = {
  ...
  entities: {
    ...
    items: {
      ...
      captains_crest: { name: "Captain's Crest" },
      priests_sigil: { name: "Priest's Sigil" },
      royal_seal: { name: "Royal Seal" },
      crypt_keystone: { name: "Crypt Keystone" },
      crypt_ritual_circle: { name: "Ritual Circle" },
      kings_signet: { name: "King's Signet" },
      nythraxis_vision: { name: "Nythraxis Vision" },
      aldrics_seal: { name: "Aldric's Seal" },
    },
