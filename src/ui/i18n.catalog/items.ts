...
const itemStringsEn = {
  itemUi: {
    ...
    market: {
      ...
      pageRange: "Showing {start}-{end} of {total} listings.",
      pagePrev: "Prev",
      pageNext: "Next",
...
export const itemStrings = {
  ...
  fr_FR: {
    itemUi: {
      ...
      market: {
        title: "Marché mondial", subtitle: "bourse du Marchand", close: "Fermer le marché", browse: "Parcourir", sell: "Vendre", collect: "Récupérer", collectWithCount: "Récupérer ({count})", noMerchant: "Approchez-vous du Marchand pour faire affaire.", emptyBrowse: "Le marché est calme. Soyez le premier à publier quelque chose dans l'onglet Vendre.", browseNote: "Marchandises proposées par les aventuriers du royaume. Choisissez Acheter pour obtenir un lot immédiatement.", searchPlaceholder: "Rechercher sur le marché...", searchAria: "Rechercher sur le Marché mondial par nom d'objet", emptySearch: "Aucun bien ne correspond à votre recherche. Essayez un autre nom.", truncated: "Affichage de {shown} sur {total} résultats. Affinez votre recherche pour voir le reste.", merchantStock: "Stock du Marchand", stackCount: "x{count}", each: "{money} l'unité", buy: "Acheter", reclaim: "Reprendre", buyAria: "Acheter {item} pour {price}", reclaimAria: "Reprendre {item}", sellNote: "Listez des marchandises depuis vos sacs. Le Marchand prend {cut}% quand un objet est vendu. Vous utilisez {used}/{max} emplacements.", sellPickEmpty: "Cliquez sur un objet dans vos sacs pour choisir quoi vendre.", quantity: "Quantité", quantityOf: "sur {count}", priceEach: "Prix unitaire", listButton: "Publier au Marché mondial", minPriceError: "Indiquez un prix d'au moins 1 cuivre.", collectEmpty: "Rien en attente. Les recettes et annonces expirées se récupèrent ici.", collectNote: "Recettes et biens retournés que le Marchand garde pour vous.", saleProceeds: "Recettes de vente", collectAll: "Tout récupérer",
      },
  ...
  it_IT: {
    itemUi: {
      ...
      market: {
        title: "Mercato Mondiale", subtitle: "scambio del Mercante", close: "Chiudi mercato", browse: "Sfoglia", sell: "Vendi", collect: "Ritira", collectWithCount: "Ritira ({count})", noMerchant: "Avvicinati al Mercante per trattare.", emptyBrowse: "Il mercato è silenzioso. Sii il primo a pubblicare qualcosa nella scheda Vendi.", browseNote: "Merci pubblicate dagli avventurieri del reame. Scegli Compra per acquistare subito una pila.", searchPlaceholder: "Cerca nel mercato...", searchAria: "Cerca nel Mercato Mondiale per nome oggetto", emptySearch: "Nessun bene corrisponde alla ricerca. Prova con un altro nome.", truncated: "Mostrati {shown} di {total} risultati. Affina la ricerca per vedere il resto.", merchantStock: "Scorte del Mercante", stackCount: "x{count}", each: "{money} ciascuno", buy: "Compra", reclaim: "Riprendi", buyAria: "Compra {item} per {price}", reclaimAria: "Riprendi {item}", sellNote: "Metti in vendita merci dalle borse. Il Mercante prende il {cut}% quando un oggetto viene venduto. Usi {used}/{max} spazi.", sellPickEmpty: "Clicca su un oggetto nelle borse per scegliere cosa vendere.", quantity: "Quantità", quantityOf: "di {count}", priceEach: "Prezzo unitario", listButton: "Metti sul Mercato Mondiale", minPriceError: "Indica un prezzo di almeno 1 rame.", collectEmpty: "Non c'è nulla in attesa. Ricavi e inserzioni scadute si ritirano qui.", collectNote: "Ricavi e merci restituite che il Mercante conserva per te.", saleProceeds: "Ricavi di vendita", collectAll: "Ritira tutto",
      },
  ...
  zh_TW: {
    itemUi: {
      ...
      market: {
        title: "世界市場", subtitle: "商人的交易所", close: "關閉市場", browse: "瀏覽", sell: "出售", collect: "領取", collectWithCount: "領取（{count}）", noMerchant: "靠近商人才能交易。", emptyBrowse: "市場很安靜。到出售分頁率先上架物品。", browseNote: "來自全境冒險者的貨物。選擇購買即可直接買下一組。", searchPlaceholder: "搜尋市場...", searchAria: "依物品名稱搜尋世界市場", emptySearch: "沒有商品符合你的搜尋。請嘗試其他名稱。", truncated: "顯示 {total} 個相符中的 {shown} 個。請細化搜尋以查看其餘內容。", merchantStock: "商人庫存", stackCount: "x{count}", each: "每個 {money}", buy: "購買", reclaim: "取回", buyAria: "以 {price} 購買 {item}", reclaimAria: "取回 {item}", sellNote: "從背包上架貨物。物品售出時商人抽取 {cut}%。你正在使用 {used}/{max} 個上架位。", sellPickEmpty: "點擊背包中的物品來選擇要出售的貨物。", quantity: "數量", quantityOf: "共 {count}", priceEach: "單價", listButton: "上架到世界市場", minPriceError: "價格至少為 1 銅幣。", collectEmpty: "沒有待領取內容。銷售收益和過期上架會在這裡領取。", collectNote: "商人為你保管的收益和退回貨物。", saleProceeds: "銷售收益", collectAll: "全部領取",
      },
  ...
  ja_JP: {
    itemUi: {
      ...
      market: {
        title: "ワールドマーケット", subtitle: "商人の取引所", close: "市場を閉じる", browse: "閲覧", sell: "売却", collect: "受取", collectWithCount: "受取（{count}）", noMerchant: "取引するには商人に近づいてください。", emptyBrowse: "市場は静かです。売却タブで最初に何かを出品しましょう。", browseNote: "王国中の冒険者が出品した品です。購入を選ぶとスタックを即時購入します。", searchPlaceholder: "市場を検索...", searchAria: "アイテム名でワールドマーケットを検索", emptySearch: "検索に一致する商品がありません。別の名前をお試しください。", truncated: "{total}件中{shown}件を表示。検索を絞り込んで残りを表示してください。", merchantStock: "商人の在庫", stackCount: "x{count}", each: "各 {money}", buy: "購入", reclaim: "回収", buyAria: "{item}を{price}で購入", reclaimAria: "{item}を回収", sellNote: "バッグから品物を出品します。売れると商人が{cut}%を受け取ります。出品枠 {used}/{max} を使用中です。", sellPickEmpty: "売るものを選ぶにはバッグ内のアイテムをクリックしてください。", quantity: "数量", quantityOf: "/ {count}", priceEach: "単価", listButton: "ワールドマーケットに出品", minPriceError: "価格は最低1銅貨にしてください。", collectEmpty: "待機中のものはありません。売上と期限切れの出品はここで受け取ります。", collectNote: "商人が預かっている売上と返却品です。", saleProceeds: "売上", collectAll: "すべて受け取る",
      },
