...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Endless Glory 官方网站',
  'seo.officialBody':
    'endlessglory.vercel.app 是 Claudemoon 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。',
  ...
  'wallet.standaloneAppHelp':
    '主屏幕应用暂不支持连接钱包。若要使用 Phantom 或 Solflare，请在 Safari 或 Chrome 中打开 Endless Glory。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '批准后请从主屏幕返回 Endless Glory。如果 iOS 打开了浏览器，请将其关闭并重新打开主屏幕应用。',
  ...
  'wallet.browser.safety': 'Endless Glory 绝不会索要助记词或私钥。',
  ...
  'wallet.browser.completeBody': '现在可以返回 Endless Glory 桌面应用。',
  ...
  'playerCard.defaultRealm': 'EndlessGlory 世界',
  ...
  'playerCard.shareText':
    '我正在 Endless Glory 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：',
  'playerCard.nativeShareTitle': 'EndlessGlory 世界',
  ...
  'controls.chat': '打开聊天框',
  'seo.title': 'Endless Glory：经典风格网页 MMO',
  'seo.description':
    '在 Endless Glory 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'a11y.githubProject': '打开 Endless Glory 的 GitHub 项目',
  'a11y.discordCommunity': '加入 Endless Glory 的 Discord 社区',
  'a11y.donateProject': '捐赠支持 Endless Glory',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '从新的主屏幕图标打开 Endless Glory。',
  ...
  'guide.worldPage.intro':
    'Endless Glory 是一片连绵不绝、需你徒步穿越的大陆，三大区域由南向北依次铺展。这里没有快速旅行，因此旅途本身便是冒险的一部分。',
  ...
  'hudChrome.nativeUpdate.body': 'Endless Glory 有新版本可用。立即更新以获取最新修复和改进。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Endless Glory {version} 版本已可用。立即更新以获取最新修复和改进。',
  ...
  'desktop.crash.fatalBody': 'Endless Glory 遇到意外错误，需要关闭。',
  ...
  'editor.docTitle': '地图编辑器 - Endless Glory',
