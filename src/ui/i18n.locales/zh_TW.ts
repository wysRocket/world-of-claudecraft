...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Endless Glory 官方網站',
  'seo.officialBody':
    'endlessglory.vercel.app 是 Claudemoon 世界的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。',
  ...
  'wallet.standaloneAppHelp':
    '主畫面應用程式目前尚不支援連接錢包。若要使用 Phantom 或 Solflare，請在 Safari 或 Chrome 中開啟 Endless Glory。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '核准後請從主畫面返回 Endless Glory。如果 iOS 開啟了瀏覽器，請將其關閉並重新開啟主畫面 App。',
  ...
  'wallet.browser.safety': 'Endless Glory 絕不會要求復原短語或私鑰。',
  ...
  'wallet.browser.completeBody': '現在可以返回 Endless Glory 桌面應用程式。',
  ...
  'playerCard.shareText':
    '我正在 Endless Glory 中鑄就傳說：{level}級 {className}{tierBit}。加入我的世界：',
  ...
  'controls.chat': '開啟對話框',
  'seo.title': 'Endless Glory：經典風格網頁 MMO',
  'seo.description':
    '在 Endless Glory 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的世界，提升職業等級並擊敗敵人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人遊戲',
  ...
  'a11y.githubProject': '開啟 Endless Glory 的 GitHub 專案',
  'a11y.discordCommunity': '加入 Endless Glory 的 Discord 社群',
  'a11y.donateProject': '捐贈支持 Endless Glory',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '從新的主畫面圖示開啟 Endless Glory。',
  ...
  'mode.play': '開始遊戲',
  'mode.playAria': '遊玩 Endless Glory',
  ...
  'guide.worldPage.intro':
    'Endless Glory 是一片你需徒步橫越的連綿大地，三大區域由南向北排列。沒有快速旅行，所以旅程本身就是冒險的一部分。',
  ...
  'desktop.crash.fatalBody': 'Endless Glory 發生未預期的錯誤，必須關閉。',
  ...
  'editor.docTitle': '地圖編輯器 - Endless Glory',
