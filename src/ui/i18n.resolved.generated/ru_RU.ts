...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Доступна новая версия Endless Glory. Обновите сейчас, чтобы получить последние исправления и улучшения.",
      "bodyWithVersion": "Доступна версия {version} Endless Glory. Обновите сейчас, чтобы получить последние исправления и улучшения.",
      "notNow": "Не сейчас",
      "update": "Обновить"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "family": {
      ...
      "golem": {
        "name": "Големы",
        "desc": "Оживлённые изваяния из камня и янтаря, медлительные, но сокрушительно сильные, что охраняют места, к которым привязаны."
      },
      "humanoid": {
        "name": "Гуманоиды",
    ...
    "worldPage": {
      "heading": "Мир",
      "intro": "Endless Glory - это единый цельный край, который вы пересекаете пешком, три зоны, протянувшиеся с юга на север. Здесь нет быстрых перемещений, так что дорога - это часть приключения.",
      "hub": "Опорная база",
  ...
  "editor": {
    ...
    "docTitle": "Редактор карт - Endless Glory",
  ...
  "mode": {
    ...
    "play": "Играть",
    "playAria": "Играть в Endless Glory",
  ...
  "wallet": {
    ...
    "standaloneAppHelp": "Подключение кошелька пока недоступно в приложении с главного экрана. Для Phantom или Solflare откройте Endless Glory в Safari или Chrome.",
    ...
    "manualReturnStandaloneHelp": "После подтверждения вернитесь в Endless Glory с экрана «Домой». Если iOS откроет браузер, закройте его и снова откройте приложение с экрана «Домой».",
    ...
    "browser": {
      ...
      "safety": "Endless Glory никогда не запрашивает фразу восстановления или закрытый ключ.",
      ...
      "completeBody": "Можно вернуться в приложение Endless Glory.",
  ...
  "playerCard": {
    ...
    "shareText": "Я создаю свою легенду в Endless Glory: уровень {level}, {className}{tierBit}. Присоединяйтесь к моему миру:",
    "nativeShareTitle": "Мир EndlessGlory",
  ...
  "seo": {
    ...
    "description": "Отправьтесь в эпическое приключение в Endless Glory, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к постоянному общему миру, развивайте классы и побеждайте врагов.",
    "genre": "MMORPG",
    "playMode": "Многопользовательская игра",
    "applicationCategory": "Игра",
    "operatingSystem": "Веб-браузер",
    "officialLabel": "Официальный сайт Endless Glory",
    "officialBody": "endlessglory.vercel.app - официальная бесплатная браузерная MMO для мира Claudemoon. Играйте онлайн с постоянным персонажем, исследуйте мир в одиночку офлайн, читайте wiki и переходите по проверенным ссылкам сообщества с этого сайта."
  },
  "a11y": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "quit": "Выйти",
      "fatalBody": "Endless Glory столкнулась с непредвиденной ошибкой и будет закрыта."
    }
  },
  "gpuNotice": {
