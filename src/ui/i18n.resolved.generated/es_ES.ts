...
export const es_ES: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Ya hay disponible una nueva versión de Endless Glory. Actualiza ahora para obtener las últimas correcciones y mejoras.",
      "bodyWithVersion": "La versión {version} de Endless Glory ya está disponible. Actualiza ahora para obtener las últimas correcciones y mejoras.",
      "notNow": "Ahora no",
      "update": "Actualizar"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "El mundo",
      "intro": "Endless Glory es una sola tierra continua que recorres a pie, tres zonas dispuestas de sur a norte. No hay viaje rápido, así que el trayecto forma parte de la aventura.",
  ...
  "editor": {
    ...
    "docTitle": "Editor de Mapas - Endless Glory",
  ...
  "wallet": {
    ...
    "standaloneAppHelp": "Las conexiones de cartera aún no están disponibles en la aplicación de la pantalla de inicio. Abre Endless Glory en Safari o Chrome para usar Phantom o Solflare.",
    ...
    "manualReturnStandaloneHelp": "Tras la aprobación, vuelve a Endless Glory desde tu pantalla de inicio. Si iOS abre un navegador, ciérralo y vuelve a abrir la aplicación de la pantalla de inicio manualmente.",
    ...
    "browser": {
      ...
      "safety": "Endless Glory nunca solicita tu frase de recuperación ni tu clave privada.",
      ...
      "completeBody": "Puedes volver a la aplicación de escritorio de Endless Glory.",
  ...
  "playerCard": {
    ...
    "defaultRealm": "Mundo de EndlessGlory",
    ...
    "shareText": "Estoy forjando mi leyenda en Endless Glory: nivel {level} {className}{tierBit}. Únete a mi mundo:",
    "nativeShareTitle": "Mundo de EndlessGlory",
  ...
  "seo": {
    ...
    "description": "Emprende una aventura épica en Endless Glory, un micro-MMO de estilo clásico jugable directamente en tu navegador. Únete a un mundo compartido persistente, sube de nivel tus clases y derrota a tus enemigos.",
    "genre": "MMORPG",
    "playMode": "Multijugador",
    "applicationCategory": "Juego",
    "operatingSystem": "Navegador web",
    "officialLabel": "Sitio web oficial de Endless Glory",
    "officialBody": "endlessglory.vercel.app es el MMO de navegador gratuito oficial del mundo Claudemoon. Juega en línea con un personaje persistente, explora en solitario sin conexión, lee la wiki y sigue los enlaces comunitarios verificados desde este sitio."
  },
  "a11y": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Recargar",
      "quit": "Salir",
      "fatalBody": "Endless Glory tuvo un error inesperado y debe cerrarse."
    }
  },
  "gpuNotice": {
  ...
  "serverUnavailable": {
    "title": "Endless Glory: Mundo no disponible",
